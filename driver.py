...
from Regex_Entities.regex_entities import sub_journalism_terms


def main():
    ##Set directories
    data_dir ="/home/wlane/PycharmProjects/ksc/Data/kickstarter_corpus.json"
    ...
    for i, prediction in enumerate(predictions):
        print("Predicted: " + prediction + "\tGold: " + test_data[i]['category'])
